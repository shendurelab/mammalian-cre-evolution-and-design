### from Kundaje lab git repo 
### https://github.com/kundajelab/scATAC-reprog/blob/88d27d4ed6914834f39e86215bdb3ef5cf315a3b/src/processing/20210715_resolve_peaks/resolve.py
...
with gzip.open(args.narrowPeak) as f:
    for x in tqdm.tqdm(f):
        ...
        if len(intersects)==0:
            if summit-HALF_WIDTH >= 0: ### edited to make sure no intervals are out of chromosome regions
